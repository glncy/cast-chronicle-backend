            ...
            <div class="row p-3">
                <div class="col-sm-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-approved" role="tab" aria-controls="v-pills-messages" aria-selected="false">Approved</a>
                ...
                <div class="col-sm-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-drafts" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            ...
                            ?>
                                <div class="col-sm-12" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 10px;box-shadow: -1px 1px 3px rgba(0,0,0,0.3); border-radius: 5px;">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="openLink('<?php echo $obj[$loop]['id']; ?>')">Edit</button>
                                </div>
                            <?php
                                }
                                $loop++;
                        ...
                        <div class="tab-pane fade" id="v-pills-approved" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            ...
                            ?>
                                <div class="col-sm-12" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 10px;box-shadow: -1px 1px 3px rgba(0,0,0,0.3); border-radius: 5px;">
                                    ...
                                    <button class="btn btn-info">Publish</button>&nbsp<button class="btn btn-info">Edit</button>
                                </div>
                            <?php
                                }
                                $loop++;
                        ...
                        <div class="tab-pane fade" id="v-pills-published" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            ...
                            ?>
                                <div class="col-sm-12" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 10px;box-shadow: -1px 1px 3px rgba(0,0,0,0.3); border-radius: 5px;">
                                    ...
                                    <button class="btn btn-info">Edit</button>&nbsp<button class="btn btn-danger">Unpublish</button>
                                </div>
                            <?php
                                }
                                $loop++;
