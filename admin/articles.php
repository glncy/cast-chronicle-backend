            ...
            <div class="row p-3">
                <div class="col-sm-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-approved" role="tab" aria-controls="v-pills-profile" aria-selected="false">Approved</a>
                ...
                <div class="col-sm-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-pending" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            ...
                            ?>
                                <div class="col-sm-12" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 10px;box-shadow: -1px 1px 3px rgba(0,0,0,0.3); border-radius: 5px;">
                                    ...
                                    <p>
                                        <?php echo $obj[$loop]['user_details']['fname']." ".$obj[$loop]['user_details']['lname']; ?> | <?php echo $obj[$loop]['date_time']; ?>
                                    </p>
                        ...
                        <div class="tab-pane fade" id="v-pills-approved" role="tabpanel" aria-labelledby="v-pills-profile-tab">
